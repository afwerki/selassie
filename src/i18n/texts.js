    ...
    heroSlides: [
      {
        ...
        subtitle:
          "በለንደን ውስጥ ያለው የኢትዮጵያ ኦርቶዶክስ ማኅበር መንፈሳዊ ቤት። ወደ ጸሎት፣ አገልግሎትና ኅብረት እንፍለጋችሁ ይመጡ።",
        cta: "ተጨማሪ ይመልከቱ",
        href: "#about",
      },
      {
        title: "እምነት፣ ማኅበር፣ ባህል",
        subtitle:
          "በኢትዮጵያ ኦርቶዶክስ ተዋሕዶ ቤተክርስቲያን ውስጥ በአንድነት እየተዳበረ ያለ ማኅበራዊ ሕይወት።",
        cta: "ትምህርቶች ይመልከቱ",
        href: "#sermons",
      },
      {
        title: "የዘላለም ጥበብ ጥሩ መዝገብ",
        subtitle: "ዘላለማዊ ትምህርቶችን ከትውልድ ወደ ትውልድ መጠበቅ።",
        cta: "ፕሮግራሞች ይመልከቱ",
        href: "#events",
      },
    ],
