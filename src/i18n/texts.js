export const texts = {
  en: {
    ...
    hero: {
      btnPrimary: "View Service Times",
      btnSecondary: "Plan Your Visit",
    },
    ...
    heroSlides: [
      ...
      {
        title: "Faith. Community. Tradition.",
        subtitle:
          "Growing together in the Ethiopian Orthodox Tewahedo Church.",
        cta: "Watch Sermons",
        href: "#sermons",
      },
      {
...
Pictures to add: Sunday School, Begena, Kirrar, and Mezmure.`,
        ...
        },
        {
          ...
          shortDescription:
            "Monthly support packages and pastoral care for families facing hardship in our community.",
          longDescription:
            "Through this outreach ministry, the parish provides food support, clothing, small emergency grants, and regular pastoral visits for families experiencing financial or emotional difficulty, ensuring that no member of the body of Christ feels forgotten.",
          status: "in_progress",
          startDate: "2024-03-12",
        },
        {
          id: "p4",
          title: "Digital Media & Livestream Upgrade",
          shortDescription:
            "Improving cameras, audio, and livestreaming so that more faithful can join the services online.",
          longDescription:
            "With many faithful unable to attend in person, this project upgrades our cameras, microphones, and streaming setup. It helps us share the Divine Liturgy, sermons, and teachings with those who are housebound, abroad, or discovering the Church for the first time.",
          status: "completed",
  ...
  am: {
    nav: {
      ...
      news: "ዜና", 
      contact: "ያግኙን",
      amharicToggle: "English",
      englishToggle: "English",
    },

    hero: {
      btnPrimary: "የአገልግሎት ሰዓቶች",
      btnSecondary: "መጉብኘትዎን ያቀዱ",
    },

    heroSlides: [
      {
        title: "ሥላሴ የኢትዮጵያ ኦርቶዶክስ ቤተክርስቲያን በለንደን",
        subtitle:
          "በለንደን የኢትዮጵያ ኦርቶዶክስ ምእመናን መንፈሳዊ ቤት። ኑ በጸሎት አበረን እንትጋ።",
        cta: "ተጨማሪ ይመልከቱ",
        href: "#about",
      },
      {
        title: "እምነት፣ ማኅበር፣ ባህል",
        subtitle:
          "በኢትዮጵያ ኦርቶዶክስ ተዋሕዶ ቤተክርስቲያን ውስጥ አንድነት እና ፍቅር እየዳበረ ያለ ማኅበራዊ እሴታችንን ከዚህ በተሻለ መልኩ አበረን እንገባ።",
        cta: "ትምህርቶችን ይመልከቱ",
        href: "#sermons",
      },
      {
        title: "የዘላለም ጥበብን ከትውልድ ወደትውልድ እናስተላልፍ",
    ...
    home: {
      ...
      welcomeP2:
        `ረዘም ላለ ጊዜ አበርውን ቢቆዩ ወይም ለመጀመሪያ ጊዜ ቢመጡ፣ በእኛ ዘንድ በደስታ እልቀበላለል፣ ስለመጣቹ በጣም ደስተኛ ነን።
በአካል ቤተከርስቲያን ሲመጡ ሁሉም ሰው በፍቅር ይቀበልዎታል።
ሰላም ይበሉ። ሰው ይተዋዎቁ።`,
      missionTitle: "ተልዕኳችን",
      missionP1:
        "ተልዕኳችን የኢትዮጵያ ኦርቶዶክስ ተዋሕዶ ቤተክርስቲያን ትምህርት መጠበቅና ማካፈል፣ የአባላትን መንፈሳዊ እድገት መደገፍ እና ማኅበራችንን በፍቅርና በትሕትና ማገልገል ነው።",
      missionP2:
        `በአገልግሎት፣ በትምህርት፣ በመንፈሳዊ ህይዎት እና በበጎ አድራጎት  የክርስቶስን ፍቅር መስብክ እና በህይዎት ኑረን ለማሳየት መሞከር ነው።
ተልዕኳችን ሰው ሁሉ በክርስቶስ ፊት  አንድ ነው እና ሁሉንም ሰው በአንድ አስተምሮ እና ገስፆ መልካም ትውልድ መፍጠር ነው።`,
      missionReadMore: "ተጨማሪ ያንብቡ",
      missionReadLess: "ዝርዝሩን አቁሙ",
    },

    projects: {
      pageTitle: "የቤተክርስቲያን ፕሮጀክቶች",
      pageIntro:
        "ቤተክርስቲያናችን በማኅበራዊ አገልግሎት፣ በወጣቶች መንፈሳዊ ትምህርት እና በቤተክርስቲያን ግንባታ የምትሠራባቸውን ዋና ፕሮጀክቶች ይመልከቱ።",
      items: [
        {
          id: "p1",
          title: "የቤተክርስቲያን እድሳት እና ዘመናዊ ማድረግ",
          shortDescription:
            "የውስጥ መልክ፣ መሬት፣ መብራት፣ መስቀሎች እና ግንኙነት የሚያሻሽል ሙሉ የእድሳት ፕሮጀክት።",
          longDescription:
            "ይህ ፕሮጀክት የቤተ እግዚአብሔርን ቅዱስ ቦታ በክብር ማድረግና ለመጥረቢያ እና ለቤተሰቦች መግባባት ቀላል የሚያደርገውን እንቅስቃሴ ይዟል። አዲስ መሬት፣ የሙቀት ስርዓት፣ የመብራት ማሻሻያ፣ የመስቀሎች እድሳት እና ለቤተሰቦች የተሻለ መቀመጫ ማዘጋጀትን ያካትታል።",
          status: "in_progress",
          startDate: "2024-01-20",
        },
        {
          id: "p2",
          title: "የወጣቶች ትምህርት እና መንፈሳዊ ማዕከል",
          shortDescription:
            "ለወጣቶች መጽሐፍ ቅዱስ ትምህርት፣ ቋንቋ ትምህርት፣ መዝሙር ስልጠና እና መንፈሳዊ መከታተያ የተለየ ቦታ።",
          longDescription:
            "ይህ ፕሮጀክት ወጣቶችን በመጽሐፍ ቅዱስ ትምህርት፣ በአማርኛ እና ትግርኛ ቋንቋ ትምህርቶች፣ በመዝሙር ልምድ እና በቡድን ውይይት በመደገፍ ሃይማኖታዊ ሕይወታቸውን እና መንፈሳዊ ቅርስን ለማጠናከር ይወዳድራል።",
          status: "planned",
          startDate: "2024-05-10",
        },
        {
          id: "p3",
          title: "የችግኝ ውስጥ ያሉ ቤተሰቦችን መደገፍ",
          shortDescription:
            "በየወሩ የምግብና የመልበስ ድጋፍ እና መንፈሳዊ ጉብኝት ለችግኝ ውስጥ ያሉ ቤተሰቦች።",
          longDescription:
            "በዚህ ማኅበራዊ አገልግሎት ፕሮግራም እርስ በርሳችን እንጋራ በምንለው መንፈስ የምግብ ድጋፍ፣ የመልበስ እርዳታ፣ ትንሽ የእጅ ገንዘብ ድጋፍ እና የካህናት ጉብኝት ይቀርባል። እንዲሁም በችግኝ ውስጥ ያሉ አባላት በማኅበሩ ውስጥ እንዳይረሱ ይረዳል።",
          status: "in_progress",
          startDate: "2024-03-12",
        },
        {
          id: "p4",
          title: "የዲጂታል ገጽታ እና ንቁ ሕዝብ ማድረግ",
          shortDescription:
            "ለቀርቶ ያሉ አባላት እንኳን አገልግሎቱን እንዲከታተሉ ካሜራ፣ ድምፅ እና ቀጥታ ስርጭትን ማሻሻል።",
          longDescription:
            "በዚህ ፕሮጀክት ንቁ ቤተክርስቲያን መሆንን በመፈለግ የካሜራ፣ የማይክሮፎን እና የቀጥታ ስርጭት መሳሪያዎችን እድሳት እና ስልጠና ይካሄዳል። በዚህ መንገድ በቤት የሚቆዩ፣ በውጭ አገር የሚኖሩ ወይም ቤተክርስቲያንን በመጀመሪያ ጊዜ የሚያውቁ አባላት አገልግሎቱን በቀላሉ ሊከታተሉ ይችላሉ።",
          status: "completed",
          startDate: "2023-11-05",
        },
      ],
