...
export const sectionTexts = {
  ...
  am: {
    sermons: {
      sectionTitle: "ትምህርቶች vedio, በፅሁፍ እንዲሁም በጥያቄ እና መልስ",
      sectionIntro:
        `ትምህርቶችን በተለያየ መልኩ ሰላዘጋጀናቸው እዚህ ላይ መርጠው ራስዎን በመንፈሳዊ ህይዎት ያዳበሩ።
የሚፈልጉት እዚህ ያላገኙት ነገር ካለ ከታች መልክት ይላኩልን፤ ያገኘነውን እናካፍላለን። `,
