    ...
    const defaultSlides = [
      {
        ...
        highlightWords: ["Holy Trinity", "Orthodox"],
        subtitle:
          "A welcoming Ethiopian Orthodox Tewahedo church in London — rooted in faith, prayer, worship, and a strong spiritual community.",
        cta: "Watch Sermons",
        href: "/#sermons",
        image: heroImages[0],
        video: heroVideos[0],
      ...
      },
      {
        ...
        title: "Rooted in Tradition, Growing in Grace",
        highlightWords: ["Tradition", "Grace"],
        subtitle:
          "Discover sermons, reading materials, and church life shaped by Orthodox teaching, sacred worship, and faithful community life.",
        cta: "Reading Materials",
      ...
      },
      {
        ...
        title: "Experience Worship, Service, and Church Family Life",
        highlightWords: ["Worship", "Church Family"],
        subtitle:
          "Explore ministries, events, and meaningful ways to connect, serve, and grow together as one church family in Christ.",
        cta: "Upcoming Events",
        href: "/#events",
        image: heroImages[2],
        video: heroVideos[2],
          ...
          <div className="hero__content">
            <div className="heroText" key={`${lang}-${active}`}>
              ...
              <h1 className="heroText__title heroAnim heroAnim--2 amharic-fix">
                {renderTitle(activeSlide?.title, activeSlide?.highlightWords)}
              </h1>
              ...
              <div className="heroStats heroAnim heroAnim--5">
